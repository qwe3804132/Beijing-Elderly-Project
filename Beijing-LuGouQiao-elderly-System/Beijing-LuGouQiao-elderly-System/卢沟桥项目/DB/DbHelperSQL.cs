...
namespace 卢沟桥项目.DB
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static readonly string maindataConnectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        ...
        public static int GetMaxID(string FieldName, string TableName, string Where,string connectionString)
        {
        ...
        {
            object obj = GetSingle(strSql, cmdParms,connectionString);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        /// 执行查询语句，返回DataSet
        /// </summary>
        /// <param name="SQLString">查询语句</param>0
        ...
        public static DataSet Query(string SQLString, bool GetPrimaryKey, string connectionString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                DataSet ds = new DataSet();
