...
{
    public partial class JtShenPi : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
             if (e.CommandName == "tongyi")
            {
                ...
                bool result = b_money.updateReasonSHE("",ID,AID,3);
            ...
            if (e.CommandName == "search")
            {
                ...
                applyInfo = b_apply.getInfo(UID, 1);
        ...
        protected void ok_Click(object sender, EventArgs e)
        {
            ...
            //webclass.Show(this, selectID.ToString());
            int AID = Convert.ToInt32(Session["UID"].ToString());
            bool result = b_money.updateReasonSHE(text, selectID,AID,2);
            if (result == true)
            {
                webclass.Show(this,"操作成功");
                GridView1.DataBind();
