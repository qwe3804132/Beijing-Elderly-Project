<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardApply.aspx.cs" Inherits="卢沟桥项目.Pages.LaoRen.CardApply" %>
...
<br />
        <div class="bottom">
        <asp:CheckBox  ID="cbx_agree" Text="我已阅读并同意" runat="server" Font-Size="12pt" ForeColor="#d1d1d1" Height="25px"/>
